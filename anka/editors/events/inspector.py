...
class _InspectorBase(ttk.Frame):
    """Shared plumbing: scrollable card, debounced instant commits.

    (Third copy of this base — decisions/characters have siblings; extracting
    editors/common/inspector_base.py is a follow-up refactor, own commit.)"""
...
class EventInspector(_InspectorBase):
    def __init__(self, master, owner):
